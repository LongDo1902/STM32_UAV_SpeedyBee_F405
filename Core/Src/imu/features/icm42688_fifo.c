...
ICM42688_Get_FIFO_Mode(ICM42688_Handle_t *handle, ICM42688_FIFO_Mode_t *mode)
{
    ...
    uint8_t           _reg    = 0U;
    HAL_StatusTypeDef _status = ICM42688_ReadReg(handle, ICM42688_UB0_FIFO_CONF, &_reg);
    if (_status != HAL_OK)
        return ICM42688_ERROR;
...
ICM42688_Set_FIFO_Resume_Partial_Read(ICM42688_Handle_t *handle, ICM42688_FIFO_Resume_Read_t state)
{
    if (!handle)
        return ICM42688_ERROR;
    HAL_StatusTypeDef _status = ICM42688_Update_Reg_Bits(
        handle, ICM42688_UB0_FIFO_CONF1, ICM42688_FIFO_RESUME_PARTIAL_RD_Msk,
...
ICM42688_Get_FIFO_Watermark(ICM42688_Handle_t *handle, uint16_t *fifoWatermark)
{
    ...
    HAL_StatusTypeDef _status = ICM42688_ReadRegs(handle, ICM42688_UB0_FIFO_CONF2, _fifo_wm_buf, 2);
    if (_status != HAL_OK)
        return ICM42688_ERROR;
...
ICM42688_Get_FIFO_Count(ICM42688_Handle_t *handle, uint16_t *fifoCount)
{
    ...
    HAL_StatusTypeDef _status =
        ICM42688_ReadRegs(handle, ICM42688_UB0_FIFO_COUNTH, _fifo_count_buf, 2);
    if (_status != HAL_OK)
        return ICM42688_ERROR;
...
ICM42688_Get_FIFO_Frame_In_Record(ICM42688_Handle_t *handle, ICM42688_FIFO_Frame_t *frame)
{
    ...
    HAL_StatusTypeDef _status = ICM42688_Get_FIFO_Count(handle, &_fifo_count_in_record);
    if (_status != HAL_OK)
        return ICM42688_ERROR;
...
ICM42688_Get_FIFO_Frame_In_Byte(ICM42688_Handle_t *handle, uint8_t *rawBuf, uint16_t rawSize)
{
    ...
    HAL_StatusTypeDef _status = ICM42688_Get_FIFO_Count(handle, &_fifo_count_in_byte);
    if (_status != HAL_OK)
        return ICM42688_ERROR;
